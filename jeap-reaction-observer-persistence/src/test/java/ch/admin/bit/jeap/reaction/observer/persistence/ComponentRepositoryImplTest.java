...
class ComponentRepositoryImplTest {
    ...
    @Test
    void getComponents() {
        List<String> componentNames = componentRepository.getComponentNames();
    ...
    void getMultipleSystems() {
        ...
        List<String> componentRepositorySystemNames = componentRepository.getComponentNames();
        assertThat(componentRepositorySystemNames).containsExactlyInAnyOrder("component0", "component1", "component2");
    }

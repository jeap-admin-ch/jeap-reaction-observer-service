...
### Fixed
- Documentation: the link to the jEAP OAuth mock server in [Getting started](docs/getting-started.md) pointed at
  the libraries section instead of the reusable microservices section, which broke the documentation site build.
...
### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 40.5.0 → 40.6.0 (minor)
